...
const YogaSutraFun = () => {
  ...
  useEffect(() => {
    Object.keys(data1).length > 0 && setBhasyaContent(data1[`Bhashya${selectedSutra}`])
    Object.keys(data2).length > 0 && setSutraContent(data2[`Sutra${selectedSutra}`])
    Object.keys(data3).length > 0 && setVrittiContent(data3[`Vritti${selectedSutra}`])
