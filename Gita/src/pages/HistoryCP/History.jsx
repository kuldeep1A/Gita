              ...
              <div className='fi-items'>
                <div>
                  ...
                  <p className='size-7'>
                    ...
                    gita. From inception to realization, our project has evolved
                    to become a platform that showcases our institution&apos;s
                  ...
                  <p className='size-7'>
                    ...
                    repository that preserves the history and accomplishments of
                    Bhagavad gita and onther gita&apos;s. The idea was to
                    provide an accessible and organized platform for students,
                    faculty, and alumni to engage with the institution&apos;s
                    heritage.
                  </p>
                  ...
                  <p className='size-7'>
                    ...
                    interface, developing the backend, and curating content to
                  ...
                  <p className='size-7'>
                    As our project unfolded, we integrated a number of features
                    designed to facilitate users in exploring a wide range of
                    historical content.{' '}
                    <em
                  ...
                  <p className='size-7'>
                    ...
                    noteworthy milestones. From the inception of the first line
                    of code to the beta testing phase, each stride propelled us
                    forward in our mission to craft a digital time capsule that
                    captures the essence of our dedication to two remarkable
                    individuals.
                  </p>
                  ...
                  <p className='size-7'>
                    ...
                    expansions as we aim to create a dynamic and vibrant
                    repository.
                  </p>
                  ...
                  <p className='size-7'>
                    ...
                    ensure that our history remains vibrant and accessible for
                    generations to come.
                  </p>
                </div>
              </div>
