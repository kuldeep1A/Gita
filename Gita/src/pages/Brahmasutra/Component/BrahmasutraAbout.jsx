            ...
            <section id='post-content' role='main'>
              ...
              <div className='fi-items'>
                <p className='size-7'>
                  ...
                  Prasthana Trayi are the Upanishads, the Bhagavadgita and the
                  Brahma Sutra. The Upanishads are the sruti prasthana, the
                  revealed texts (sruti - that which is heard); the Bhagavadgita
                  ...
                  complete without a close examination of the Prasthana Trayi.
                </p>
                <p className='size-7'>
                ...
                <p className='size-7'>
                  ...
                  The fourth chapter (Phala: the fruit) talks of the state that
