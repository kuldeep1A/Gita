              ...
              <section id='post-content' role='main'>
                ...
                <div className='fi-items'>
                  <p className='size-7'>
                    ...
                    the Brahma Sutra. The Upanishads are the sruti prasthana,
                    the revealed texts (sruti - that which is heard); the
                    Bhagavadgita is the smriti prasthana, composed by sages
                    based on their understanding of the Vedas (smriti - that
                    which is remembered); the Brahma Sutra is the nyaya
                    prasthana, the logical text that sets forth the philosophy
                    systematically (nyaya - logic/order). No study of Vedanta is
                  ...
                  <p className='size-7'>
                    ...
                    The Brahma Sutra is known by many names: it is also called
                  ...
                  <p className='size-7'>
                    ...
                    Vedantic texts talk of Brahman, the ultimate reality, which
                    is the goal of life. The second chapter (Avirodha:
                    non-conflict) discusses and refutes the possible objections
                    against Vedanta philosophy. The third chapter (Sadhana: the
                    means) describes the process by which ultimate emancipation
                  ...
                  <p className='size-7'>
                    ...
                    extant one being the one by Adi Sankara. Later commentators
